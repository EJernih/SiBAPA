...
<a href="{{ route('bhpRequests.index') }}">
    ...
    <div class="wizard-content">
        <form id="requestForm" class="tab-wizard wizard-circle wizard" action="{{ route('bhpRequests.update', $bhpRequest->id) }}" method="POST" enctype="multipart/form-data"> 
        @csrf
        @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="semester" placeholder="Semester" value="{{$bhpRequest->semester}}" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Tahun ajaran :</label>
                            <input type="text" class="form-control" name="academic_year" placeholder="Tahun ajaran" value="{{$bhpRequest->academic_year}}"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="request_by" placeholder="Diajukan Oleh" value="{{$bhpRequest->request_by}}" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
    ...
    <script>
        $(document).ready(function() {
            ...
            // inisialisasi form bhpRequests yang dari form wizard
            $('#requestForm').steps({
                headerTag: "h5",
                bodyTag: "section",
