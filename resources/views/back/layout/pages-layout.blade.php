...
<html>
	<head>
		...
		<link
			rel="stylesheet"
			type="text/css"
			href="{{ asset('back/vendors/styles/icon-fon') }}t.min.css"
		/>
		<link rel="stylesheet" type="text/css" href="{{ asset('back/vendors/styles/style.cs') }}s" />
	...
	<body>
			...
			<div class="header-right">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<div class="notification-list mx-h-350 customscroll">
								<ul>
									...
									<li>
										<a href="#">
											<img src="{{ asset('back/vendors/images/photo1.j') }}pg" alt="" />
											<h3>Lea R. Frith</h3>
											<p>
												Lorem ipsum dolor sit amet, consectetur adipisicing
												elit, sed...
									...
									<li>
										<a href="#">
											<img src="{{ asset('back/vendors/images/photo2.j') }}pg" alt="" />
									...
									<li>
										<a href="#">
											<img src="{{ asset('back/vendors/images/photo3.j') }}pg" alt="" />
											<h3>John Doe</h3>
											<p>
												Lorem ipsum dolor sit amet, consectetur adipisicing
												elit, sed...
									...
									<li>
										<a href="#">
											<img src="{{ asset('back/vendors/images/photo4.j') }}pg" alt="" />
				...
				<div class="github-link">
					<a href="https://github.com/dropways/deskapp" target="_blank"
						><img src="{{ asset('back/vendors/images/github.s') }}vg" alt=""
					/></a>
				</div>
			</div>
		</div>
		...
		<!-- sidebar kiri kumpulan menu -->
		<div class="left-side-bar">
			<div class="brand-logo">
				<a href="index.html" class="app-name">SiPBHP</a>
					...
					<ul id="accordion-menu">
						...
						<li>
							...
							>
								...
								<span class="mtext"
									>Landing Page
									<img src="{{ asset('back/vendors/images/coming-s') }}oon.png" alt="" width="25"
								/></span>
							</a>
						</li>
					</ul>
		...
		<!-- JS untuk jQuery dan Bootstrap Datepicker -->
